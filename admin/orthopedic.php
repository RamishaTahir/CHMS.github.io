...
<h2>Spinal Fractures and Paralysis</h2><br>
<p style="font-size: 15px;text-align:justify;">
  Spinal fracture (PARALYSIS) or spinal instability is a cause of abnormal movement between two vertebrae. This abnormality can lead to damage or pain in the nerves and spinal cord. Spinal fractures are mostly due to sports injuries, falls, car injuries and gunshots. Symptoms of spinal fracture include numbness, back or neck pain, weakness, muscle spasm, paralysis, tingling and bowel or bladder changes. Doctors conduct X-rays, CT Scan and MRI to diagnose the severity of the situation</p>
...
<div class="p-2 w-50 bd-highlight">
    <iframe 
      width="346" height="211"  src="https://www.youtube.com/embed/ZQ8veBNuAeg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen ></iframe>
</div>
</div>
...
?>
 ...
 <div class="container">
    ...
    <h2 style="text-align: center; padding-top: 9px;">Conditions:</h2><br> 
</div>
        ...
        <div  style="font-size: 15px;" >
          <h2 >Disc Replacement Surgery</h2><br>
  <div class="card-body"  >

    <p class="card-text" style="text-align:justify;"> Any unremitting lower back pain that has been there from at least six months and is not getting better from medication may require disc replacement surgery to restore one’s ability to function. The painful disc is replaced with a prosthetic implant with an aim to bring back normal function. There are certain health conditions that can prevent one from getting a disc replacement surgery. These conditions include osteoporosis, spinal tumor, pregnancy, vertebral body fracture and allergy to the materials in the artificial implant</p></div>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-9">
 
        <div  style="font-size: 15px;">
          <h2  > Total Knee Replacement Surgery</h2><br>
  <div class="card-body" style="text-align:justify;" >

    <p class="card-text" style="">
If a patient’s knee is sternly damaged by arthritis or because of any injury, it may be difficult for them to perform everyday activities, such as climbing stairs or walking. After a period, they may even begin to feel pain while sitting or lying down. When non-surgical treatments like use of walking supports and medications prove no longer to be helpful, the doctor may advise the patient to undergo a total knee replacement surgery. It is a safe procedure that helps in pain relief, corrects leg deformity and helps the patient resume normal activities.</p></div>
</div>
</div> 
<div class="col-lg-4 col-md-6 col-sm-9">
 
        <div  style="font-size: 15px;" >
          <h2 >Joint Replacement Surgery</h2><br>
  <div class="card-body" >

    <p class="card-text" style="text-align:justify;"> 

Offered by best ortho hospitals in India, joint replacement surgery is a procedure in which parts of a damaged joint are replaced with prosthesis. The prosthesis is usually made from metal, ceramic or plastic. It easily replicates the movement of a healthy joint. Joint replacement surgery is performed on knee, hip, wrist, ankle, elbow and shoulder. The most commonly performed ones include hip and knee replacements.</p></div>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-9">
 
        <div  style="font-size: 15px;">
          <h2  >Hip Replacement Surgery</h2><br>
  <div class="card-body" >

    <p class="card-text" style="text-align:justify"> 
Total hip replacement surgery intends to relieve hip pain and increase its function by resurfacing the bones that meet at the hip joint. The surgeon removes the femoral head and replaces it with prosthesis. This prosthetic femur head is in a shape of a ball and fits seamlessly into the rounded cup prosthesis that becomes the new socket of the pelvis.</p></div>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-9">
