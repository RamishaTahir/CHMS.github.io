				...
				<div class="card-body">
					<form method="post" id="patient_register_form">
						...
						<div class="form-group">
							...
							<input type="password" name="patient_password" id="patient_password" class="form-control" required  data-parsley-trigger="keyup" minlength="8" />
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="patient_phone_no" id="patient_phone_no" class="form-control" required  data-parsley-trigger="keyup" minlength="11" maxlength="14"  autocomplete="off" />
								</div>
