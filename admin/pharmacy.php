...
$conn = mysqli_connect("localhost","root","","doctor_appointment") or die("connection failed");
 $query = "SELECT * FROM pharmacy  where pharmacy_type= 'panadol' order by rand() " ;
...
<div class="card" style="width: 28rem; margin-left: 2rem;font-size: 15px;margin-top: 105px;">
        <div class="text-center"> 
             ...
             <img class="card-img-top rounded"   src="<?php echo $row['pharmacy_image'] ?>" alt="Card image cap" style="width: 120px; height:130px"  >    
  

 <h3 style="width:40rem; margin-left: -60px "> <?php echo $row['pharmacy_name']?></h3><br>
  <div class="card-body">
           <a href="Cardiologydoctor1.php?id=<?php echo $row['pharmacy_id']?>" class="btn"> Learn More  <span class="fas fa-chevron-right"></span> </a>
