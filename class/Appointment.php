...
class Appointment
{
	public $base_url = 'http://localhost:8080/doctor-appointment-management-system/';
	public $connect;
	public $query;
	public $statement;
	public $now;
	...
	public function __construct()
	{
		...
		date_default_timezone_set('Asia/Kolkata');  //php func that set default time zone that use by  all date/time funcation in script.

		session_start();

		$this->now = date("Y-m-d H:i:s",  STRTOTIME(date('h:i:sa'))); //it is php fun syntx date(fomate,timestamp)
	}                                                                    //strtotime it take time since unix 1 jan 1970
