		          	...
		          	<div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" name="doctor_password" id="doctor_password" class="form-control" required  data-parsley-trigger="keyup"  minlength="8" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_name" id="doctor_name" class="form-control" required data-parsley-trigger="keyup" autocomplete="off" />
                            </div>
                         <span id="doctor_name_err" style="color: red; font-size: 13px;"></span>
                      ...
                      <span id="doctor_phone_no_err" style="color: red; font-size: 13px;"></span>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_date_of_birth" id="doctor_date_of_birth" readonly class="form-control" autocomplete="off" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_degree" id="doctor_degree" class="form-control" required data-parsley-trigger="keyup" autocomplete="off"/>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_expert_in" id="doctor_expert_in" class="form-control" required  data-parsley-trigger="keyup" autocomplete="off"/>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_Education" id="doctor_Education" class="form-control" required  data-parsley-trigger="keyup" autocomplete="off"/>
                            </div>
                                  <span id="doctor_expert_in_err" style="color: red; font-size: 13px;"></span>
                             ...
                             <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_Awards" id="doctor_Awards" class="form-control" required  data-parsley-trigger="keyup" autocomplete="off" />
                            </div>
                                  <span id="doctor_expert_in_err" style="color: red; font-size: 13px;"></span>
                             ...
                             <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_Interest" id="doctor_Interest" class="form-control" required  data-parsley-trigger="keyup" autocomplete="off"/>
                            </div>
                                  <span id="doctor_expert_in_err" style="color: red; font-size: 13px;"></span>
                             ...
                             <div class="col-md-6">
                                ...
                                <input type="text" name="doctor_About" id="doctor_About" class="form-control" required  data-parsley-trigger="keyup" autocomplete="off" />
                            </div>
                                  <span id="doctor_expert_in_err" style="color: red; font-size: 13px;"></span>
...
$('#doctor_name').keypress(function (e) {
        ...
        {
        e.preventDefault();
        $("#doctor_name_err").html("Alphabets Only").show().fadeOut("slow");
        return false;
        }
    });
...
$(document).ready(function () {
  ...
  $("#doctor_phone_no").keypress(function (e) {
     ...
     if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
        ...
        $("#doctor_phone_no_err").html("Digits Only").show().fadeOut("slow");
               return false;
    }
   });
});
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
                ...
                $('#doctor_expert_in').val(data.doctor_expert_in);
                 $('#doctor_Education').val(data.doctor_Education);
                 $('#doctor_About').val(data.doctor_about);

                 $('#doctor_Awards').val(data.doctor_award);

                 $('#doctor_Interest').val(data.doctor_interest);
