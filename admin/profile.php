                    ...
                    <form method="post" id="profile_form" enctype="multipart/form-data">
                        <div class="row"><div class="col-md-8"><span id="message"></span><div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <span id="admin_name_err" style="color: red; font-size: 13px;"></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="admin_password" id="admin_password" class="form-control" required data-parsley-maxlength="16" data-parsley-trigger="keyup" minlength="8" />
...
function myFunction() {
  ...
  if (x.type === "password") {
    ...
    x.type = "password";
                                 ...
                                 <span id="hospital_name_err" style="color: red; font-size: 13px;"></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hospital_contact_no" id="hospital_contact_no" class="form-control" required  data-parsley-trigger="keyup" autocomplete="off" minlength="11" maxlength="14" />
                                        </div>
                    <span id="hospital_contact_no_err" style="color: red; font-size: 13px;"></span>
...
$(document).ready(function () {
  ...
  $("#hospital_contact_no").keypress(function (e) {
     //if the letter is not digit then display error and don't type anything
     if (e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57)) {
        //display error message
        $("#hospital_contact_no_err").html("Digits Only").show().fadeOut("slow");
               return false;
    }
   });
});
...
$('#admin_name').keypress(function (e) {
        ...
        {
        e.preventDefault();
        $("#admin_name_err").html("Alphabets Only").show().fadeOut("slow");
        return false;
        }
    });
...
$('#hospital_name').keypress(function (e) {
        var regex = new RegExp("^[a-zA-Z]+$");
        var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
        if (regex.test(str)) {
            return true;
        ...
        {
        e.preventDefault();
        $("#hospital_name_err").html("Alphabets Only").show().fadeOut("slow");
        return false;
        }
    });
